 ...
 */
final class Version20201011222907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_64C19C1A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1A4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES enterprise (id)');
